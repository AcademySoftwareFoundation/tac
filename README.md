...
| Representative | Appointed By | Role | Special Role | Organization | Title |
| -------------- | ----- | ------------ | --- | --- | -- |
|  Bill Roberts | Membership Entitlement | Voting Rep | None | Adobe Systems, Inc. | Sr Director of Strategy |
...
|  Greg Denton | Membership Entitlement | Voting Rep | None | Microsoft Corporation | Senior Program Manager |
...
| [Open Shading Language](https://github.com/AcademySoftwareFoundation/OpenShadingLanguage) [![License](https://img.shields.io/github/license/AcademySoftwareFoundation/OpenShadingLanguage)](https://github.com/AcademySoftwareFoundation/OpenShadingLanguage/blob/master/LICENSE) | [![GitHub Stars](https://img.shields.io/github/stars/AcademySoftwareFoundation/OpenShadingLanguage)](https://github.com/AcademySoftwareFoundation/OpenShadingLanguage) [![CII Best Practices](https://bestpractices.coreinfrastructure.org/projects/3061/badge)](https://bestpractices.coreinfrastructure.org/projects/3061) [![GitHub issues by-label](https://img.shields.io/github/issues/AcademySoftwareFoundation/OpenShadingLanguage/good%20first%20issue)](https://github.com/AcademySoftwareFoundation/OpenShadingLanguage/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) | [![Build Status](https://travis-ci.org/imageworks/OpenShadingLanguage.svg?branch=master)](https://travis-ci.org/imageworks/OpenShadingLanguage) [![Appveyor status](https://ci.appveyor.com/api/projects/status/github/imageworks/openshadinglanguage?svg=true&branch=master)](https://ci.appveyor.com/project/lgritz/openshadinglanguage) |
