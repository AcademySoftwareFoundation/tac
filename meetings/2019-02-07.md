...
In person meeting as part of the Open Source Forum at the Academy of Motino Picture Arts and Sciences, Beverly Hills, CA.
...
New members: NVIDIA, present a first board meeting.

Eric Enderton from NVIDIA is new TAC member. Director of Film Rendering Technology at NVIDIA. Originally worked with Larry Gritz on Gelatto project. They are interested in helping people use GPUs as much as possible.
...
* Changes to the CLA (Contributor License Agreement): Larry Gritz, after getting all clearances from Sony legal (based on OpenVDB CLAs), but last minute change after vote was taken, may need a re-vote to switch to simplified CLA (provided by Linux Foundation)
