...
* John: [CommunityBridge](https://www.linuxfoundation.org/press/press-release/the-linux-foundation-launches-new-communitybridge-platform-to-help-sustain-open-source-communities) introduction
...
* Update on industry / candidate projects
    ...
    * Data projects (e.g. [wikihuman](https://gl.ict.usc.edu/Research/DigitalEmily2/), datasets like [Moana Island](https://disneyanimation.com/resources/moana-island-scene/)
