...
* CII Best Practices Badge discussion (David Wheeler)
    ...
    * Key requirement is project must use a static analysis tool: [cppcheck](https://cppcheck.sourceforge.net/) for instance. There are suggestions to use tools that specifically check for security issues (not required).
