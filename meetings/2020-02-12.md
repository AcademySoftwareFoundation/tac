...
* Working groups [0:10-0:30]
    ...
    * Proposals
        ...
        * USD
            ...
            * Daniel: is Cory comfortable with the approach presented above? Cory: yes, but needs to make sure the Pixar USD team is OK. Some discussion on the [usd-interest mailing list](https://groups.google.com/g/usd-interest) today. A lot of "community helping community" on that list.
...
* Update on candidate projects [0:40-0:50]
    ...
    * Media player (Darby)
        ...
        * Darby Johnston is the author of the [DJV](https://github.com/grizzlypeak3d/DJV) playback application
