...
* OpenCue Packaging and deployment (Brian)
    ...
    * Docker is a whole other can of worms, LF has a [blog post from April 2020](https://www.linuxfoundation.org/blog/2020/04/docker-containers-what-are-the-open-source-licensing-considerations/) on the topic. Daniel: where’s the line between artefacts, containers, and other forms of binary distributions.
