...
TSCs often will add additional roles on as-needed basis to manage different areas or roles within a project. TSCs can come up with the right definitions and scope for these roles, but it's highly advised to document them to ensure expectations are aligned.

Roles we've seen in project include but aren't limited to...
...
Using LFX Project Control Center, you can easily schedule one-off or recurring meetings that automatically send invites to TSC members, allow other interested parties to register for meetings, and record meetings and make available for others. Additionally it provides great statistics for meeting attendance which can help you assess member engagement.
...
For public meetings, LFX PCC provides a public link for sharing the meeting with non-attendees so they can regsiter for the meeting. It's recommened to make that link available publically.
